...
int GSM_REDIAL_LAST_TELEPHONE_NUMBER_USED() {
	return EXECUTE_COMMAND_RESPONSELESS_EX(REDIAL_LAST_TELEPHONE_NUMBER_USED,
			Execute, 0);
}

int GSM_SET_COMMAND_ECHO_MODE(int echo) {
	return EXECUTE_COMMAND_RESPONSELESS_EX(SET_COMMAND_ECHO_MODE, Execute,
			&echo);
}
...
int GSM_REQUEST_MANUFACTURER_IDENTIFICATION(char * data) {
	Response_TypeDef response;
...
int GSM_REQUEST_TA_MODEL_IDENTIFICATION(char * data) {
	Response_TypeDef response;
...
int GSM_REQUEST_TA_REVISION_IDENTIFICATION_OF_SOFTWARE_RELEASE(char * data) {
	Response_TypeDef response;
...
int GSM_REQUEST_GLOBAL_OBJECT_IDENTIFICATION(char * data) {
	Response_TypeDef response;
...
int GSM_REQUEST_TA_SERIAL_NUMBER_IDENTIFICATION(char * data) {
	Response_TypeDef response;
