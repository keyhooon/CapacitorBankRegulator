...
void SeedCallLog() {
	AddMessageEx((const char*) "09124575442", 1545090000, 1, 0);
	AddMessageEx((const char*) "09124463992", 1545000000, 1, 1);
	AddMessageEx((const char*) "09127093902", 1545000001, 0, 1);
	AddMessageEx((const char*) "09121015197", 1545000002, 1, 1);
	AddMessageEx((const char*) "09121143144", 1545000003, 0, 1);
	AddMessageEx((const char*) "09354463261", 1545091200, 0, 1);
}
